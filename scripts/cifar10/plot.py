...
if __name__ == '__main__':
    ...
    # ResNet20 inputs
    parser.add_argument('--res20_flops',            required=True, help='Path to ResNet20 flops_auto results.json')
    parser.add_argument('--res20_params',           required=True, help='Path to ResNet20 params_auto results.json')
    parser.add_argument('--res20_energy',           required=True, help='Path to ResNet20 energy results.json')
    parser.add_argument('--res20_energy_act_aware', required=True, help='Path to ResNet20 energy_act_aware results.json')
    # ResNet56 inputs
    parser.add_argument('--res56_flops',            required=True, help='Path to ResNet56 flops_auto results.json')
    parser.add_argument('--res56_params',           required=True, help='Path to ResNet56 params_auto results.json')
    parser.add_argument('--res56_energy',           required=True, help='Path to ResNet56 energy results.json')
    parser.add_argument('--res56_energy_act_aware', required=True, help='Path to ResNet56 energy_act_aware results.json')
    # Output directory
    parser.add_argument('--output_dir', default='.', help='Directory to save the generated plots')
