...
parser.add_argument("--mode", default="flops_auto", choices=["flops_auto", "params_auto", "energy_act_aware", "energy"])
...
for k in ratios_comp if args.mode == "flops_auto" or args.mode == "params_auto" else ratios_energy:
