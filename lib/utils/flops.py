...
flop_mapping = {
    ...
    aten.matmul.default: matmul_flop,
    aten.addmm: addmm_flop,
    aten.addmm.default: addmm_flop,
    aten.bmm: bmm_flop,
    aten.bmm.default: bmm_flop,
    aten.convolution: conv_flop,
    aten.convolution.default: conv_flop,
    aten._convolution: conv_flop,
    aten._convolution.default: conv_flop,
    aten.convolution_backward: conv_backward_flop,
    aten.convolution_backward.default: conv_backward_flop,
}
